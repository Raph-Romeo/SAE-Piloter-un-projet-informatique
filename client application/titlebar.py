...
class ProfileCard(QWidget):
    ...
    def __init__(self, avatarPath: str, name: str, email: str, parent=None):
        ...
        self.emailLabel.setStyleSheet('QLabel{color: '+color.name()+';font-family:verdana;font-size:12px;}')
        color = QColor(255, 255, 255) if isDarkTheme() else QColor(0, 0, 0)
        self.nameLabel.setStyleSheet('QLabel{color: '+color.name()+';font-family:verdana}')
